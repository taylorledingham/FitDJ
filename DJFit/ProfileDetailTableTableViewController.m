//
//  ProfileDetailTableTableViewController.m
//  DJFit
//
...
@interface ProfileDetailTableTableViewController ()

@end

@implementation ProfileDetailTableTableViewController {
...
- (void)viewDidLoad {
    ...
    self.ageTextField.text = [NSString stringWithFormat:@"22"];
...
- (NSSet *)dataTypesToRead {
   ...
   HKCharacteristicType *ageType = [HKCharacteristicType characteristicTypeForIdentifier:HKCharacteristicTypeIdentifierDateOfBirth];
    ...
    return [NSSet setWithObjects: heightType, weightType, ageType, biologicalSexType, nil];
}
...
- (void)updateUsersAgeLabel {
    ...
    if (!dateOfBirth) {
        ...
        self.ageTextField.text = NSLocalizedString(@"Not available", nil);
    }
    else {
